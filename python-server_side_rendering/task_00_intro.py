...
def generate_invitations(template, attendees):
    """
    Génère des fichiers d'invitation personnalisés à partir
    d'un modèle avec des espaces réservés
    et une liste d'objets. Chaque fichier de sortie est nommé séquentiellement,
    en commençant par 1.

    Args:
        template (str): Le modèle avec des espaces
        réservés au format {placeholder}.
        attendees (list): Une liste de dictionnaires
        contenant les données pour chaque invité.
